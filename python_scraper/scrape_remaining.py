#!/usr/bin/env python3
"""
MOTUS Scraper - High Speed Async Gap Scraper (5,000+ DOTs/min)
============================================================================
Checks USDOT numbers from 4,925,233 to 10,000,000.
Loads existing USDOTs from Supabase first to skip them.
Uses asyncio + aiohttp with TCP connection pooling to achieve 5,000+ DOTs/min
with minimal RAM (<80MB) and very low CPU usage (hardware safe).
"""
...
OUTPUT_CSV  = "unadded_leads_from_4582560_v5.csv"
...
async def async_main():
    ...
    print("MOTUS HIGH-SPEED ASYNC GAP SCRAPER (5,000+ DOTs/min)", flush=True)
    ...
    print("\n" + sep, flush=True)
    print("FINISHED GAP SCAN", flush=True)
    print(sep, flush=True)
