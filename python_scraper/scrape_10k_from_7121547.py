#!/usr/bin/env python3
"""
MOTUS Capped Scraper - 10k leads starting from USDOT 7121547
============================================================================
Continues from where the previous run stopped (USDOT 7121546).
Stops automatically once MAX_LEADS carriers have been found.

Usage:
  python -u scrape_10k_from_7121547.py
...
# ── Config ────────────────────────────────────────────────────────────────────
START_DOT   = 7121547      # Resume right after previous run stopped
...
OUTPUT_CSV  = "leads_10k_from_7121547.csv"
...
def main():
    ...
    print("MOTUS 10K CAPPED SCRAPER - Resume from USDOT 7,121,547", flush=True)
