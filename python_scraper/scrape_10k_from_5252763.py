#!/usr/bin/env python3
"""
MOTUS Capped Scraper - 10k leads starting from USDOT 5252763
============================================================================
Continues from where the previous run stopped (USDOT 5252762).
Stops automatically once MAX_LEADS carriers have been found.

Usage:
  python -u scrape_10k_from_5252763.py
...
# ── Config ────────────────────────────────────────────────────────────────────
START_DOT   = 5252763      # Resume right after previous run stopped
MAX_LEADS   = 10000        # Stop once this many leads are collected
CHUNK_SIZE  = 3000         # Number of DOTs to probe per batch
MAX_WORKERS = 80           # Parallel threads (bumped up for speed)
OUTPUT_CSV  = "leads_10k_from_5252763.csv"
...
def main():
    ...
    print("MOTUS 10K CAPPED SCRAPER - Resume from USDOT 5,252,763", flush=True)
