...
============================================================================
Streams leads_missing_from_4582560_new_scrape.csv and upserts carrier records into Supabase DB.
...
- Resumable: Checkpoints progress to import_new_progress.json after every batch.
"""
...
CSV_FILE = "leads_missing_from_4582560_new_scrape.csv"
PROGRESS_FILE = "import_new_progress.json"
